...
| Chapter | Contents |
|---|---|
| [Packages and dependencies](packages.md) | The `otc` project tool: scaffolding, local dependencies, the bench harness, manifests, the lockfile, version resolution, and the capability model. |
