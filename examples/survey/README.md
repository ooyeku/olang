...
```bash
olang examples/survey/main.ol                 # survey the current directory
olang examples/survey/main.ol summary src/    # a specific directory
olang examples/survey/main.ol langs . --top 8 # every language, by lines
olang examples/survey/main.ol files . -n 15   # the largest files
```
...
olang build examples/survey/main.ol -o survey
./survey summary src/

# generate its reference from the /// and //! doc comments
olang doc examples/survey/main.ol -o survey.html
```
