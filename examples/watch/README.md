...
```bash
olang examples/watch/main.ol "date +%T"           # stream a command, every 800ms
olang examples/watch/main.ol -n 500 "seq 3"       # every 500ms
olang examples/watch/main.ol -c 5 "uptime"        # stop after 5 runs
...
```bash
olang build examples/watch/main.ol -o watch
